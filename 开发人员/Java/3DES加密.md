# 3DES加密(双倍长)
[2018-01-31 17:14:02](#data.create_time)<br>
[转自:缘梦星雨](http://www.cnblogs.com/yangw/p/4776802.html)<br>
##### 使用
```java
   String key="32位密钥";
   String secStr="32位密文";
   String decStr=ThreeDes.byte2HexStr(
            ThreeDes.decrypt(secStr,ThreeDes.hexStr2Str(key))
            );
   System.out.println("解密数据:"+decStr);
```
##### 工具类
```java
package com.mpos.tools;
