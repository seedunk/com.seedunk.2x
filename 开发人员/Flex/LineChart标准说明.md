# LineChart 
* 包 mx.charts
* 类 public class LineChart
* 继承 LineChart>CartesianChart>ChartBase>UIComponent > FlexSprite >Sprite >DisplayObjectContainer >InteractiveObject >DisplayObject  >EventDispatcher >Object
``` 
<?xml version="1.0"?>
...
<mx:Application xmlns:mx="http://www.adobe.com/2006/mxml">
    ...
    <mx:SolidColor id="sc1" color="blue" alpha=".3"></mx:SolidColor>
    <mx:SolidColor id="sc2" color="red" alpha=".3"></mx:SolidColor>
    <mx:SolidColor id="sc3" color="green" alpha=".3"></mx:SolidColor>

    <!-- Define custom Strokes. -->
    <mx:Stroke id = "s1" color="blue" weight="2"></mx:Stroke>
    <mx:Stroke id = "s2" color="red" weight="2"></mx:Stroke>
    <mx:Stroke id = "s3" color="green" weight="2"></mx:Stroke>
    ...
    <mx:Panel title="LineChart and AreaChart Controls Example" 
        ...
        <mx:Legend dataProvider="{linechart}"></mx:Legend>
        ...
        <mx:Legend dataProvider="{Areachart}"></mx:Legend>
